(function () {
  ...
  (function () {
    ...
    if (!showcase) return;
    const PROJECTS = [
      { host: "jaydenmusic.com", url: "https://jaydenmusic.com/", desktop: "img/jaydenmusic-desktop.jpg?v=3", mobile: "img/jaydenmusic-mobile.jpg?v=3", name: "Jayden", kindKey: "kind.jayden", kindFr: "Site web · Artiste musical", descKey: "desc.jayden", descFr: "Site officiel du chanteur Jayden — rock, soul et poésie." },
      { host: "yumea-wellness.be", url: "https://www.yumea-wellness.be/", desktop: "img/yumea-desktop.jpg?v=3", mobile: "img/yumea-mobile.jpg?v=3", name: "Yuméa Wellness", kindKey: "kind.yumea", kindFr: "Site web · Bien-être & Head Spa", descKey: "desc.yumea", descFr: "Institut de Head Spa japonais et de soins du visage." },
    ...
    if (finePointer && !prefersReduced) {
      ...
      const laptop = showcase.querySelector(".laptop-device");
