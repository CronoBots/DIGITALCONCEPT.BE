(function () {
  ...
  (function () {
    ...
    if (!showcase) return;
    const PROJECTS = [
      { host: "cronobots.github.io/YUMEA", url: "https://cronobots.github.io/YUMEA/", desktop: "img/yumea-desktop.jpg", mobile: "img/yumea-mobile.jpg", name: "Yuméa Wellness", kindKey: "kind.yumea", kindFr: "Site web · Bien-être & Head Spa", descKey: "desc.yumea", descFr: "Site vitrine élégant pour Yuméa Wellness, institut dédié au Head Spa japonais et aux soins du visage et du cuir chevelu." },
